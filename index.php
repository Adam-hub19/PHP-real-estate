        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container">
                        <div class="t-center">
                            <h1 data-animation="animated fadeInDown delay-05s">Find Your Home Right Heres</h1>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container">
                        <div class="t-left">
                            <h1 data-animation="animated fadeInUp delay-05s">Best Place to <br/> Find Properties</h1>
                            <p data-animation="animated fadeInUp delay-10s">
                              <!--  This is real estate website template based on Bootstrap 4 framework.-->
                            </p>
            ...
            <div class="search-contents ">
                <form  method="POST">
                 ...
                 <div class="row">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <button class="search-button btn-primary btn-color" onclick="getPropertySearch();return false;" name="btnsubmit" type="submit">For sale</button>
                            </div>
                        </div>

                        <div class="col-3">
                            <div class="form-group">
                                <button class="search-button btn-primary btn-color" onclick="getPropertySearch();return false;" name="btnsubmit" type="submit">To rent</button>
                            </div>
                        </div>

                        <div class="col-3">
                            
                                <a href="advancedSearch.php" class="btn btn-link" >Adavanced propterty search</a>
